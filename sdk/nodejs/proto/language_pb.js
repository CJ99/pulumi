...
proto.pulumirpc.RunRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    secretconfigkeysList: (f = jspb.Message.getRepeatedField(msg, 11)) == null ? undefined : f
  };
...
proto.pulumirpc.RunRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getSecretconfigkeysList();
  if (f.length > 0) {
    writer.writeRepeatedString(
      11,
      f
...
/**
 * repeated string secretConfigKeys = 11;
 * @return {!Array<string>}
 */
proto.pulumirpc.RunRequest.prototype.getSecretconfigkeysList = function() {
 ...
 * @return {!proto.pulumirpc.RunRequest} returns this
 */
proto.pulumirpc.RunRequest.prototype.setSecretconfigkeysList = function(value) {
 ...
 * @return {!proto.pulumirpc.RunRequest} returns this
 */
proto.pulumirpc.RunRequest.prototype.addSecretconfigkeys = function(value, opt_index) {
 ...
 * @return {!proto.pulumirpc.RunRequest} returns this
 */
proto.pulumirpc.RunRequest.prototype.clearSecretconfigkeysList = function() {
  return this.setSecretconfigkeysList([]);
};
